...
drives = {} # tabela de hash para os drives
gb = 1000 * 1000 * 1000
...
if (__name__ == "__main__"):
    ...
    print "drives totais:", len(drives)
    print "drives que estão completamente vazios:", null_drives
    
    remaining = len(drives) - null_drives
    
    print "drives contendo algum dado:", remaining
    print "drives maiores que 1gb não-comprimidos:", len(big)
    print
    print "para os drives maiores que 1gb não-comprimidos:"
    print "(todos os tamanhos em megabytes)"
    ...
    print "\neconomia média: %5.2f%%" % avg_savings.average()